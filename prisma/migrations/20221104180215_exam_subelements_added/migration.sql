...
INSERT INTO "new_Subelement" ("id", "name", "numExamQuestions", "numGroups", "numTotalQuestions", "subelementId") SELECT "id", "name", "numExamQuestions", "numGroups", "numTotalQuestions", "subelementId" FROM "Subelement";
